...
function PostCard({ post, currentUser, onLike, onComment, onDelete }) {
  ...
  return (
    <div style={S.postCard}>
      ...
      {post.image && <img src={`https://taskplanet-social-1.onrender.com${post.image}`} alt="post" style={S.postImg} />}
      ...
      {myPosts.length === 0 ? (
        ...
        myPosts.map((p) => (
          <div key={p._id} style={S.card}>
            ...
            {p.image && <img src={`https://taskplanet-social-1.onrender.com${p.image}`} alt="" style={{ width: "100%", borderRadius: 8, maxHeight: 160, objectFit: "cover" }} />}
